...
public class Task {
    ...
    public String toString() {
        return "Task [id=" + id + ", title=" + title + ", description=" + description + ", dueDate=" + dueDate
                ...
                + ", updated=" + updated + ", getClass()=" + getClass() + ", getId()=" + getId() + ", getTitle()="
                + getTitle() + ", getDescription()=" + getDescription() + ", getDueDate()=" + getDueDate()
                + ", getStatus()=" + getStatus() + ", getPriority()=" + getPriority() + ", getTaskList()="
                + getTaskList() + ", getCreated()=" + getCreated() + ", getUpdated()=" + getUpdated() + ", hashCode()="
